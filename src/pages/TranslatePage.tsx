    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow container px-4 mx-auto py-20">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold heading-gradient">ISL to Text Translation</h1>
          <p className="text-muted-foreground mt-2 max-w-2xl mx-auto">
            Use your webcam to translate Indian Sign Language to text in real-time.
        ...
        <Alert className="mb-8">
          ...
          <AlertDescription>
            This is a demo implementation. In a production environment, this would
            connect to your Flask backend with the LSTM model for actual translation.
          </AlertDescription>
        </Alert>
